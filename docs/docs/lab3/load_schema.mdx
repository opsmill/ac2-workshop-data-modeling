...
To go along with the schemas some data have been prepared in the directory `workshop_b2/lab3`
...
infrahubctl object load workshop_b2/lab3/data/interface.yml --branch schema01
```
