...
To save some time and focus on the most important part of the lab, a sample application providing exploring the same data in all 3 formats is available.
