...
For this lab, Docker is required to spin up an instance of a Neo4j database.

## Lab Commands

There is a CLI provided to be able to easily manage the lab using Invoke. List the available Invoke tasks.
...
Click on the <span style="color:#F16667">**Device**</span> Node Label.
